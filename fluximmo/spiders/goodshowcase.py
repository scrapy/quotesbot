...
class GoodShowCaseSpider(CrawlSpiderFluximmo):
    ...
    def parse_item(self, response):
        ...
        li_size = response.xpath(f'normalize-space({ROOT_XPATH}/*[contains(@class, "row")]//*[contains(@id, "carousel-text")]/*[contains(@class, "row")][1]/div)')
        count = 1
        while True:
            xpath = f"normalize-space({ROOT_XPATH}/*[contains(@class, 'row')]//*[contains(@id, 'carousel-text')]/*[contains(@class, 'row')][1]/div[%s])" % str(count)
